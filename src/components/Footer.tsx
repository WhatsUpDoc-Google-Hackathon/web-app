const Footer = () => (
  <footer className="w-full bg-[var(--color-bg-secondary)] border-t border-gray-200 py-4 px-8 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
