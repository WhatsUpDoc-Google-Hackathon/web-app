...
const CallSidebar = () => (
  <aside className="w-[340px] flex flex-col gap-4">
    {/* Meeting Overview */}
    <div className="rounded-2xl bg-white p-6 shadow-xl mb-2 border border-gray-200">
      <h2 className="text-lg font-bold text-accent mb-2">Meeting overview</h2>
      <p className="text-sm text-[var(--color-text)] opacity-80 mb-2">
